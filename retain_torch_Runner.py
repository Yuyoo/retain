...
def train_predict(batch_size=100, epochs=10, topk=30, L2=1e-8):
    ...
    model = Retain(inputDimSize=3393, embDimSize=300, alphaHiddenDimSize=200, betaHiddenDimSize=200, outputDimSize=283)
